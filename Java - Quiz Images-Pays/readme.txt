-
Quiz images-country
Java (Swing, Apache POI)

This program was made in an Eclipse workspace and may have problem running in other environement.

The Apache POI library did cause non-fatal errors/warnings.
A database was supposed to be implimented
but due to constraints (covid) an Excel-based import was made.
...
In short, this program asks the user for a difficulty setting
...
Due to contrainsts (again, covid), the amount countries, images,
as well as their descriptions is absurdly short.

The goal was not to make a full-fledged program (due to covid),
...
while still respecting object-oriented programming.
